...
// ---------------------------------------------------------------------------
// The tables, defined in database.cpp

extern const hadron_row hadron_database[n_hadron_rows];
extern const decay_row decay_database[n_decay_rows];

// ---------------------------------------------------------------------------
// Row of a state in hadron_database, or < 0 where the table does
// not hold it.

inline int hadron_index(int pid) {
  int lo = 0;
