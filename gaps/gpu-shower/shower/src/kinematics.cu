...
__device__ double shower::calculate_y(double t, double z, double sijk,
                                      int sf) const {
  /**
...
__device__ void shower::make_kinematics(vec4* kinematics, const double z,
...
__device__ void shower::ii_boost_after_emission(event& ev,
                                                vec4* kinematics) const {
  /**
